...
class AdminDashboardTest extends TestCase
{
    ...
    public function test_admin_can_view_dashboard_summary(): void
    {
        ...
        $this->withToken($admin->createToken('api')->plainTextToken)
            ...
            ->assertJsonPath('data.pricing_rules.pending_review', 2)
            ...
            ->assertJsonPath('data.navigation.pricing_rules.pending_review.query.monitoring_status', TherapistPricingRule::MONITORING_STATUS_UNREVIEWED)
