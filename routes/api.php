...
use App\Http\Controllers\Api\AdminSupportStepScenarioController;
...
Route::middleware('auth:sanctum')->group(function (): void {
    ...
    Route::get('/admin/support-step-scenarios', [AdminSupportStepScenarioController::class, 'index']);
    Route::post('/admin/support-step-scenarios', [AdminSupportStepScenarioController::class, 'store']);
    Route::get('/admin/support-step-scenarios/{scenario:public_id}', [AdminSupportStepScenarioController::class, 'show']);
    Route::patch('/admin/support-step-scenarios/{scenario:public_id}', [AdminSupportStepScenarioController::class, 'update']);
    Route::delete('/admin/support-step-scenarios/{scenario:public_id}', [AdminSupportStepScenarioController::class, 'destroy']);
    Route::post('/admin/support-step-scenarios/{scenario:public_id}/archive', [AdminSupportStepScenarioController::class, 'archive']);
    Route::get('/admin/support-step-scenarios/{scenario:public_id}/preview', [AdminSupportStepScenarioController::class, 'preview']);
    Route::post('/admin/support-step-scenarios/{scenario:public_id}/test-send', [AdminSupportStepScenarioController::class, 'testSend']);
    Route::post('/admin/support-step-scenarios/{scenario:public_id}/run', [AdminSupportStepScenarioController::class, 'run']);
    Route::get('/admin/support-step-scenarios/{scenario:public_id}/deliveries', [AdminSupportStepScenarioController::class, 'deliveries']);
    Route::get('/admin/support-step-deliveries', [AdminSupportStepScenarioController::class, 'deliveries']);
    ...
    Route::post('/admin/travel-requests/{travelRequest:public_id}/warn-sender', [AdminTravelRequestController::class, 'warnSender']);
