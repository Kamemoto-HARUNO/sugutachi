...
export function UserIdentityVerificationPage() {
    const { token } = useAuth();
            ...
            <section className="space-y-4 rounded-[28px] border border-white/10 bg-white/5 p-6 md:p-8">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    <div className="space-y-3">
                        <p className="text-xs font-semibold tracking-wide text-[#d2b179]">IDENTITY</p>
                        <h1 className="text-3xl font-semibold text-white">本人確認・年齢確認</h1>
                        <p className="max-w-3xl text-sm leading-7 text-slate-300">
                            予約や安全運用の前提となる、18歳以上確認と本人確認をここで行います。
                            書類画像とセルフィーは審査用途に限定して扱います。
                        </p>
                    </div>

                    <div className="rounded-2xl border border-white/10 bg-[#111923] px-5 py-4 text-sm text-slate-200">
                        <p className="text-xs font-semibold tracking-wide text-[#d2b179]">CURRENT STATUS</p>
            ...
            <section className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_380px]">
                <article className="rounded-[24px] border border-white/10 bg-white/5 p-6">
                    <div className="space-y-2">
                        <p className="text-xs font-semibold tracking-wide text-[#d2b179]">SUBMISSION</p>
                    ...
                    {!allowsSubmission ? (
                        ...
                        <form onSubmit={handleSubmit} className="mt-6 space-y-5">
                            <div className="grid gap-4 md:grid-cols-2">
                                <label className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full rounded-[18px] border border-white/10 bg-[#111923] px-4 py-3 text-sm text-white outline-none transition focus:border-[#d2b179]/50"
                                        placeholder="山田 太郎"
                                        required
                                    />
                                </label>
                            ...
                            <label className="flex items-start gap-3 rounded-2xl border border-white/10 bg-[#111923] px-4 py-3 text-sm leading-7 text-slate-300">
                                <input type="checkbox" checked readOnly className="mt-1 h-4 w-4 rounded border-white/20 bg-transparent text-[#d2b179]" />
                            ...
                            <button
                                ...
                                className="inline-flex items-center rounded-full bg-[#d2b179] px-5 py-3 text-sm font-semibold text-slate-950 transition hover:brightness-105 disabled:cursor-not-allowed disabled:opacity-60"
                            >
                ...
                <article className="space-y-4 rounded-[24px] border border-white/10 bg-white/5 p-6">
                    <div className="space-y-2">
                        <p className="text-xs font-semibold tracking-wide text-[#d2b179]">LATEST RECORD</p>
