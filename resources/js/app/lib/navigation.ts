...
export const adminPlaceholderRoutes: PlaceholderRouteDefinition[] = [
    ...
    { path: 'banners', title: 'バナー管理', description: '掲載場所、表示対象、期間ごとのバナー画像とクリック先URLを管理します。', apiPath: '/api/admin/banners' },
    { path: 'blog-posts', title: 'ブログ管理', description: 'SEO記事の作成、編集、公開ステータスを管理します。', apiPath: '/api/admin/blog-posts' },
    { path: 'blog-posts/new', title: 'ブログ新規作成', description: 'リッチテキスト本文、SEO項目、公開設定を入力します。', apiPath: '/api/admin/blog-posts' },
    { path: 'blog-posts/:publicId/edit', title: 'ブログ編集', description: '公開済み記事の本文、スラッグ、SEO項目を編集します。', apiPath: '/api/admin/blog-posts/{public_id}' },
