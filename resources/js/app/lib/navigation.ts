...
export const userPlaceholderRoutes: PlaceholderRouteDefinition[] = [
    ...
    { path: 'therapists/:publicId', title: 'タチキャスト詳細', description: 'プロフィール、メニュー、レビュー、料金根拠を確認します。', apiPath: '/api/therapists/{public_id}' },
...
export const adminPlaceholderRoutes: PlaceholderRouteDefinition[] = [
    { path: 'accounts', title: 'アカウント一覧', description: '利用者・タチキャスト・運営アカウントを管理します。', apiPath: '/api/admin/accounts' },
    ...
    { path: 'therapist-profiles', title: 'タチキャストプロフィール審査', description: 'プロフィール審査や停止中プロフィールを扱います。', apiPath: '/api/admin/therapist-profiles' },
    { path: 'therapist-profiles/:publicId', title: 'タチキャストプロフィール詳細', description: '写真、位置、受取設定まで確認できる詳細画面です。', apiPath: '/api/admin/therapist-profiles/{public_id}' },
    { path: 'profile-photos', title: '写真監視', description: 'プロフィール写真の監視と削除を行います。', apiPath: '/api/admin/profile-photos' },
